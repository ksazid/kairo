# VS-59 — Content Asset Library Foundation
...
## Provider boundary
The API/web do not call Google Drive. A connector interface defines future provider behavior; VS-59 ships no live provider implementation and no secrets/configuration. The live Google Drive connector is reserved for a separately governed future slice (VS-60).
