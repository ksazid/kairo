...
- A captured public-page fixture result is emitted by `hunter-chunk5-public-url.fixture.test.ts`, allowing the real public content to be replayed deterministically when CI cannot resolve external DNS.
