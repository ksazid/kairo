...
COPY --from=build /app/scripts/authorize-marketing-shadow-quality-evaluation.mjs ./scripts/authorize-marketing-shadow-quality-evaluation.mjs
COPY --from=build /app/scripts/export-marketing-shadow-evidence.mjs ./scripts/export-marketing-shadow-evidence.mjs
