...
import { ChannelHealthLabel, type ChannelHealth } from "../../../ui-states";
...
function channelHealth(status: ChannelAccountView["status"]): ChannelHealth { return status === "connected" ? "healthy" : status === "reconnect-required" ? "attention" : status === "disabled" ? "disconnected" : "unknown"; }
