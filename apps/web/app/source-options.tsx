  ...
  return (
    <fieldset className={styles.sourceOptions}>
      ...
      <label className={styles.sourceChoice}>
        ...
        <span>
          <span className={styles.sourceTitle}><KairoIcon name="instagram"/><strong>Connect Instagram</strong><em>Recommended</em></span>
      ...
      <label className={styles.sourceChoice}>
        ...
        <span>
          <span className={styles.sourceTitle}><KairoIcon name="facebook"/><KairoIcon name="instagram"/><strong>Connect Facebook + Instagram</strong></span>
      ...
      <label className={styles.sourceChoice}>
        ...
        <span>
          <span className={styles.sourceTitle}><KairoIcon name="facebook"/><strong>Connect Facebook only</strong></span>
