...
export function startSimpleCreation(brandId:string,input:{goal:string;input?:string;source?:string;contentPreference?:CreationFormat;presenterId?:string;mediaAssetIds?:string[];ideaId?:string}){return call<SimpleCreationView>(`/api/v1/brands/${encodeURIComponent(brandId)}/simple-creations`,{method:"POST",body:JSON.stringify(input)});}
